        ...
        {items.length === 0 ? (
          ...
          <>
              ...
              {items.map((i) => (
                <div key={i.id} className="card-flat p-4 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mono text-sm text-muted-foreground">${i.price.toFixed(2)}</div>
                  </div>
            ...
            <div className="card-flat p-6 space-y-2 mono text-sm">
              ...
              <div className="flex justify-between text-lg font-bold pt-2 border-t border-border"><span>Total</span><span>${(subtotal + fee).toFixed(2)}</span></div>
            </div>
